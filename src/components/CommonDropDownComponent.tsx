    ...
    const renderItem = (item: any) => {
        return (
            <View style={[Styles.item, { backgroundColor: colors.SECONDARY_BACKGROUND }]}>
                ...
                <Image source={item.value === props.value ? Icons.SELECTED_RADIO_BUTTON_ICON : Icons.RADIO_BUTTON_ICON} style={[{width:wp(6), height:wp(6), resizeMode:'contain'},{ tintColor: item.value === props.value ? colors.PRIMARY : colors.SECONDARY_ICON }]} />
            </View>
        );
    };
    return (
